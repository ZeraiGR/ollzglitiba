...
window.addEventListener("DOMContentLoaded", function () {
  function e(e) {
    var t = document.querySelector(".header__burger"),
        ...
        c = e.target,
        n = document.querySelector(".authorized__info");
    null != c.closest(".header__top") || c.classList.contains("header__burger") || (t.classList.remove("active"), o.classList.remove("active")), console.log(), null != c.closest(".authorized__info") || c.classList.contains("authorized__portrain") || n.classList.remove("active");
  }
  ...
  !function () {
    ...
    var n = document.querySelectorAll(".close-popup");

    if (n.length > 0) {
      var _loop2 = function _loop2(_e) {
        var t = n[_e];
        t.addEventListener("click", function (e) {
          i(t.closest(".popup")), e.preventDefault();
        });
      };
    ...
    function s(e) {
      if (e && c) {
        var _n = document.querySelector(".popup.open");
        ...
        _n ? i(_n, !1) : function () {
          ...
          t.style.paddingRight = e, t.classList.add("lock"), c = !1, setTimeout(function () {
            c = !0;
          }, 800);
        }(), e.classList.add("open"), e.addEventListener("click", function (e) {
          e.target.closest(".popup__content") || i(e.target.closest(".popup"));
        });
      }
    }
    ...
    document.addEventListener("keydown", function (e) {
      if ("Escape" === e.key) {
        i(document.querySelector(".popup.open"));
      }
    ...
    e && e.addEventListener("click", function () {
      e.classList.add("open"), t.classList.add("open"), c.classList.add("lock");
    }), o && o.addEventListener("click", function () {
      e.classList.remove("open"), t.classList.remove("open"), c.classList.remove("lock");
    });
  }(), function () {
    var t = document.querySelector(".authorized__portrain"),
        o = document.querySelector(".authorized__info");
    t && t.addEventListener("click", function () {
      o.classList.toggle("active"), o.classList.contains("active") ? window.addEventListener("click", e) : window.removeEventListener("click", e);
    });
  }(), function () {
    var e = document.querySelector(".favorite__category"),
        t = document.querySelectorAll(".favorite__item");
    e && e.addEventListener("click", function (e) {
      var o = e.target;
      o.classList.contains("favorite__item") && (t.forEach(function (e) {
        e.classList.remove("active");
      }), o.classList.add("active"));
    });
  }(), function () {
    var e = document.querySelectorAll(".instrument--catalog");
    e && e.forEach(function (e) {
      elNotLiked = e.querySelector(".instrument__add-icon"), elLiked = e.querySelector(".instrument__choosen-icon"), elNotLiked.addEventListener("click", function (t) {
        e.classList.add("choosen");
      }), elLiked.addEventListener("click", function (t) {
